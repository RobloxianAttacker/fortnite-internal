...
static inline auto SpoofCall(Ret(*fn)(Args...), Args... args) -> Ret
{
	...
	return mapper::template do_call<Ret, Args...>((const void*)&detail::test_stub, &p, args...);
}


#define SpoofCall2

uintptr_t sigscan(std::string module, std::string pattern, int result = 0)
{
